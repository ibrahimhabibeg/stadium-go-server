...
import { OwnerIdIncludedContext, UserIdIncludedContext } from "../types/context";
import { OwnerAuthorizationError, UserAuthorizationError } from "../types/graphql";

const notLoggedInOwnerError: OwnerAuthorizationError = {
  __typename: "OwnerAuthorizationError",
  message:
    "You must be a stadium owner to perform the function you requested.",
